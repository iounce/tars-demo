...
#ifndef __DATATARS_H_
#define __DATATARS_H_
...
namespace GoodsApp
{
    struct DataReq : public tars::TarsStructBase
    {
    public:
        static string className()
        {
            return "GoodsApp.DataReq";
        }
        static string MD5()
        {
            return "2e147686ffb6c34c4a114a7cdc74fc63";
        }
        DataReq()
        {
            resetDefautlt();
    ...
    inline bool operator==(const DataReq&l, const DataReq&r)
    {
    ...
    inline ostream& operator<<(ostream & os,const DataReq&r)
    {
        os << r.writeToJsonString();
        return os;
    }
    inline istream& operator>>(istream& is,DataReq&l)
    {
    ...
    struct DataRsp : public tars::TarsStructBase
    {
    public:
        static string className()
        {
            return "GoodsApp.DataRsp";
        }
        static string MD5()
        {
            return "e57019e9d35f0371ee7443402d3362bc";
        }
        DataRsp()
        {
            resetDefautlt();
    ...
    inline bool operator==(const DataRsp&l, const DataRsp&r)
    {
    ...
    inline ostream& operator<<(ostream & os,const DataRsp&r)
    {
        os << r.writeToJsonString();
        return os;
    }
    inline istream& operator>>(istream& is,DataRsp&l)
    {
        std::istreambuf_iterator<char> eos;
        std::string s(std::istreambuf_iterator<char>(is), eos);
        l.readFromJsonString(s);
    ...
    public:
        ...
        virtual void callback_doData(tars::Int32 ret,  const GoodsApp::DataRsp& rsp)
        { throw std::runtime_error("callback_doData() override incorrect."); }
        virtual void callback_doData_exception(tars::Int32 ret)
        { throw std::runtime_error("callback_doData_exception() override incorrect."); }
        virtual void callback_doData(tars::Int32 ret, GoodsApp::DataRsp&&  rsp)
        { callback_doData(ret, rsp); }
        ...
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            switch(r.first - __api_all)
            {
                case 0:
                {
                    ...
                    {
                        callback_doData_exception(_msg_->response->iRet);
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, "", ServerConfig::Application + "." + ServerConfig::ServerName, "doData", 0, _trace_param_, "");
                    }
                    ...
                    callback_doData(_ret, std::move(rsp));
    ...
    public:
        struct PromisedoData: virtual public TC_HandleBase
        {
        public:
            tars::Int32 _ret;
            GoodsApp::DataRsp rsp;
        ...
        typedef tars::TC_AutoPtr< apiPrxCallbackPromise::PromisedoData > PromisedoDataPtr;

        apiPrxCallbackPromise(const tars::Promise< apiPrxCallbackPromise::PromisedoDataPtr > &promise)
        : _promise_doData(promise)
        {}
        
        virtual void callback_doData(const apiPrxCallbackPromise::PromisedoDataPtr &ptr)
        {
            _promise_doData.setValue(ptr);
        }
        virtual void callback_doData_exception(tars::Int32 ret)
        {
            std::string str("");
            str += "Function:doData_exception|Ret:";
            str += TC_Common::tostr(ret);
            _promise_doData.setException(tars::copyException(str, ret));
        }

    protected:
        tars::Promise< apiPrxCallbackPromise::PromisedoDataPtr > _promise_doData;
        ...
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            switch(r.first - __api_all)
            {
                case 0:
                {
                    ...
                    apiPrxCallbackPromise::PromisedoDataPtr ptr = new apiPrxCallbackPromise::PromisedoData();
                    ...
                    {
                        callback_doData_exception(tars::TARSCLIENTDECODEERR);
    ...
    public:
        ...
        tars::Int32 doData(const GoodsApp::DataReq & req,GoodsApp::DataRsp &rsp,const map<string, string> &context = TARS_CONTEXT(),map<string, string> * pResponseContext = NULL)
        {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CS), TRACE_ANNOTATION_CS, ServerConfig::Application + "." + ServerConfig::ServerName, tars_name(), "doData", 0, _trace_param_, "");
            }

            std::map<string, string> _mStatus;
            shared_ptr<tars::ResponsePacket> rep = tars_invoke(tars::TARSNORMAL,"doData", _os, context, _mStatus);
            if(pResponseContext)
            {
            ...
            if (_pSptd_ && _pSptd_->_traceCall)
            {
                ...
                TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_CR), TRACE_ANNOTATION_CR, ServerConfig::Application + "." + ServerConfig::ServerName, tars_name(), "doData", 0, _trace_param_, "");
            }

            return _ret;
        }

        void async_doData(apiPrxCallbackPtr callback,const GoodsApp::DataReq &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
            ...
            tars_invoke_async(tars::TARSNORMAL,"doData", _os, context, _mStatus, callback);
        }
        
        tars::Future< apiPrxCallbackPromise::PromisedoDataPtr > promise_async_doData(const GoodsApp::DataReq &req,const map<string, string>& context)
        {
            tars::Promise< apiPrxCallbackPromise::PromisedoDataPtr > promise;
        ...
        void coro_doData(apiCoroPrxCallbackPtr callback,const GoodsApp::DataReq &req,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            _os.write(req, 1);
            std::map<string, string> _mStatus;
            tars_invoke_async(tars::TARSNORMAL,"doData", _os, context, _mStatus, callback, true);
        }
    ...
    public:
        virtual ~api(){}
        virtual tars::Int32 doData(const GoodsApp::DataReq & req,GoodsApp::DataRsp &rsp,tars::TarsCurrentPtr _current_) = 0;
        virtual tars::Int32 doData(GoodsApp::DataReq && req,GoodsApp::DataRsp &rsp,tars::TarsCurrentPtr _current_) 
        { return doData(req, rsp, _current_); }
        static void async_response_doData(tars::TarsCurrentPtr _current_, tars::Int32 _ret, const GoodsApp::DataRsp &rsp)
        {
            size_t _rsp_len_ = 0;
            ...
            if (_current_->isTraced())
            {
                ...
                TARS_TRACE(_current_->getTraceKey(), TRACE_ANNOTATION_SS, "", ServerConfig::Application + "." + ServerConfig::ServerName, "doData", 0, _trace_param_, "");
            }

        }
        static void async_response_push_doData(tars::CurrentPtr _current_, tars::Int32 _ret, const GoodsApp::DataRsp &rsp, const map<string, string> &_context = tars::Current::TARS_STATUS())
        {
            {
                tars::TarsOutputStream<tars::BufferWriterVector> _os;
                _os.write(_ret, 0);
                ...
                _current_->sendPushResponse( tars::TARSSERVERSUCCESS ,"doData", _os, _context);
            }
        }
            ...
            switch(r.first - __GoodsApp__api_all)
            {
                case 0:
                {
                    ...
                    if (_pSptd_ && _pSptd_->_traceCall)
                    {
                        ...
                        TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SR), TRACE_ANNOTATION_SR, "", ServerConfig::Application + "." + ServerConfig::ServerName, "doData", 0, _trace_param_, "");
                    }

                    tars::Int32 _ret = doData(std::move(req),rsp, _current);
                    if(_current->isResponse())
                    {
                        ...
                        if (_pSptd_ && _pSptd_->_traceCall)
                        {
                            ...
                            TARS_TRACE(_pSptd_->getTraceKey(ServantProxyThreadData::TraceContext::EST_SS), TRACE_ANNOTATION_SS, "", ServerConfig::Application + "." + ServerConfig::ServerName, "doData", 0, _trace_param_, "");
                        }
